...
Summary(pl):	Snortalog jest skryptem perla który podsumowuje logi snort'a
Name:		snortalog
Version:	1.9.0
Release:	%{_rc}.1
License:	GPL
...
%description -l pl
Snortalog jest skryptem perla który podsumowuje logi snort'a
sprawiajac, ¿e mo¿na ³atwo sprawdziæ przez kogo jestesmy atakowani
